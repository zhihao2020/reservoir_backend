...
def test_example_gem_card_round_trips_to_yaml_mixture() -> None:
    ...
    np.testing.assert_allclose(gem.Tc, yaml_mix.Tc)
    np.testing.assert_allclose(gem.Pc, yaml_mix.Pc)
    np.testing.assert_allclose(gem.omega, yaml_mix.omega)
    assert gem.Mw is not None and yaml_mix.Mw is not None
    np.testing.assert_allclose(gem.Mw, yaml_mix.Mw)
    np.testing.assert_allclose(gem.kij, yaml_mix.kij)
