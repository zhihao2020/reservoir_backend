...
```bash
python black_oil/validation/cmg_fault_channel/build_fault_channel.py
python black_oil/validation/cmg_fault_channel_gas/build_fault_channel_gas.py
cd black_oil/validation/cmg_fault_channel_gas
D:\Tool\CMG\IMEX\2024.20\Win_x64\EXE\mx202420.exe -f fault_channel_gas.dat
python black_oil/validation/cmg_fault_channel_gas/run_invert_eval.py
python black_oil/validation/cmg_fault_channel_gas/plot_cmg_zh.py
```
