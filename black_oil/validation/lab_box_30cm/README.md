...
python validation/lab_box_30cm/export_truth.py

# 合成孪生（无需 CMG）
python validation/lab_box_30cm/run_validate.py --synthetic --n 15

# 生成 IMEX 算例（默认 30^3；真值用 --n 50）
python validation/lab_box_30cm/build_lab_case.py --n 30
```
...
```bash
python validation/lab_box_30cm/run_inversion_eval.py --n 12 --ne 12 --na 3
```
