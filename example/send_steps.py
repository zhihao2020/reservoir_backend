"""TCP caller (protocol v2): HELLO → READY → STEP/ACK/NAK loop.

Reads this folder's observations.csv / series.csv and sends one length-prefixed
STEP per time. Defaults assume you run from ``example/`` or pass no paths.
