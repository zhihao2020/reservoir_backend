...
| 独立组分质量守恒 + TPFA（示例闪蒸，未接入 FIM） | MVP | `comp.explicit_step` | `tests/test_comp_*.py`；standalone, not wired, example PR params; 2d/2d/3d HnP + EXAMPLE streak/matrix k, not industrial-grade |
