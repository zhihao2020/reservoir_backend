...
| 独立组分质量守恒 + TPFA（示例闪蒸，未接入 FIM） | MVP | `comp.explicit_step` | `tests/test_comp_*.py`；standalone, not wired, example PR params; Peaceman rate injector not industrial-grade |
