...
```bash
python validation/black_oil/cmg_fault_3d/build_faulted_case.py
```
...
# 从 .out 回灌
python validation/black_oil/cmg_fault_3d/run_imex_and_validate.py --from-out validation/cmg_fault_3d/mxspr006_fault.out
```
