...
Usage:
  ...
  python validation/black_oil/cmg_channel_3d/run_imex_and_validate.py --synthetic

  # after IMEX produces mxspr006_channel.out (or with --execute):
  python validation/black_oil/cmg_channel_3d/run_imex_and_validate.py --from-out mxspr006_channel.out
