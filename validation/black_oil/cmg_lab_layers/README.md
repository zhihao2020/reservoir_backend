...
```bash
python validation/black_oil/cmg_lab_layers/build_lab_layers.py
cd validation/black_oil/cmg_lab_layers
D:\Tool\CMG\IMEX\2024.20\Win_x64\EXE\mx202420.exe -f lab_layers.dat
python validation/black_oil/cmg_lab_layers/run_invert_eval.py
```
...
```bash
python validation/black_oil/cmg_lab_layers/plot_cmg_inv_fields.py
```
