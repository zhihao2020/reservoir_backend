...
```bash
python validation/black_oil/cmg_fault_channel_lib/build_fault_channel_lib.py
cd validation/black_oil/cmg_fault_channel_lib
D:\Tool\CMG\IMEX\2024.20\Win_x64\EXE\mx202420.exe -f fault_channel_lib.dat
python validation/black_oil/cmg_fault_channel_lib/run_lib_smoke.py
python validation/black_oil/cmg_fault_channel_lib/run_invert_eval.py
python validation/black_oil/cmg_fault_channel_lib/plot_cmg_zh.py
```
