...
同一套旋钮（nowcast / invert_rock）在通道 / 断层 / 实验室山形层理上扫测点数。  
...
python validation/black_oil/inversion_generality/run_eval.py --methods point_first,grid_esmda --n 10 --ne 8 --na 2
```
